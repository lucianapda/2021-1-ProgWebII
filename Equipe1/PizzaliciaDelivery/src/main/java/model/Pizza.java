...
public class Pizza {
	...
	public void removerSabor(String sabor) {
		...
		System.out.println("sabor '" + sabor + "' removido da pizza.");
	}
	
	public void alterarSabor(String saborRemover, String saborAdicionar ) {
		this.removerSabor(saborRemover);
		this.adicionarSabor(saborAdicionar);
	}

	public void setSabores(String[] sabores) {
		if (sabores.length != this.getSabores().length) {
			throw new IllegalArgumentException(
					"O valor do vetor de sabores precisa ser igual a " + this.getSabores().length);
		}
